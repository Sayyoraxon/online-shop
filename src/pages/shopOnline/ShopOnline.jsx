...
const ShopOnline = ({ products }) => {
    return (
        <div className='max-w-[1108px] mx-auto'>
            <img src={brand} alt="brand" />
            <div className='relative mt-5 w-1/2 flex flex-wrap justify-between ml-auto'>
                <div className='absolute sm:w-[265px] w-[120px] sm:h-[265px] h-[120px] rounded-full bg-gray-200 sm:-left-[320px] -left-[140px] sm:-bottom-[100px] flex justify-center items-center'>
