...
const CrShopStep3 = () => {
    ...
    return (
        <div className='relative z-20 w-[644px] h-auto bg-white rounded-[15px] flex flex-col items-center gap-5 py-10 px-[50px] shadow-md'>
            ...
            className='overflow-hidden w-full h-[243px] rounded-[15px] bg-white border-[2px] border-black border-dashed flex flex-col gap-4 justify-center items-center'>
